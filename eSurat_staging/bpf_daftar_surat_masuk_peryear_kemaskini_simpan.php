<?php 
    ...
    case "kemaskini":	
		//--------------------------------------------- Kemaskini Daftar Surat Mula ----------------------------------------------------------------------------------------------	
					...
					$surat_daripada =$_POST['surat_daripada'];
   ...
   echo '<meta HTTP-EQUIV="REFRESH" content="0; url=bpf_daftar_surat_masuk_list_permonth.php?mode=kemaskini&action=1&id_daftar='.$id_daftar.'&jenis_surat=1&tahun='.$tahun.'&bulan='.$bulan.'">';
