...
<script>
  ...
  <form id="form_daftar_masuk" name="form_daftar_masuk" method="post" action="bpf_daftar_surat_masuk_simpan.php"  enctype="multipart/form-data" onSubmit="return checksuratmasuk();" >  
