<?php 
    ...
    case "task":
		...
		//--------------------------------------------- Maklumat assignment mula ----------------------------------------------------------------------------------------------	
					...
					$sql_tambah_daftar = "INSERT INTO maklumat_daftar_surat_masuk (perkara, jenis_surat, no_ruj_fail_btm, kategori_surat, surat_daripada, tarikh_daftar, no_ruj_surat, tarikh_surat, dirujuk_kepada_id, tarikh_rujuk, staf_key_in, datekeyin, aktif) VALUES ('$perkara', '1', '$no_ruj_fail_btm', '$kategori_surat', '$surat_daripada', '$tarikh_daftar', '$no_ruj_surat', '$tarikh_surat', '$dirujuk_kepada_id', '$tarikh_rujuk', '$id', '$datecreated','Y')" ;					
					$result_tambah_daftar = mysql_query($sql_tambah_daftar) or die("ERROR in query sql_tambah_daftar : $sql_tambah_daftar ".mysql_error());
					
					$sql_latest = "SELECT * FROM maklumat_daftar_surat_masuk where aktif = 'Y' ORDER BY id_daftar desc LIMIT 1";
					...
					?><script>alert("Daftar Surat Masuk ke Dalam Rekod BPF Berjaya!");
					 </script> <?php
						
		//--------------------------------------------- Maklumat assignment tamat ----------------------------------------------------------------------------------------------				
        break;		
    default:
