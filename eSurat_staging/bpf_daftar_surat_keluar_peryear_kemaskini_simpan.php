<?php 
    ...
    case "kemaskini":	
		//--------------------------------------------- Kemaskini Daftar Surat Keluar Mula ----------------------------------------------------------------------------------------------	
					...
					$surat_kepada =$_POST['surat_kepada'];
   ...
   echo '<meta HTTP-EQUIV="REFRESH" content="0; url=btm_daftar_surat_keluar_list_permonth.php?mode=kemaskini&action=2&id_daftar='.$id_daftar.'&jenis_surat=2&tahun='.$tahun.'&bulan='.$bulan.'">';
