...
<script>
  ...
  <form id="form_daftar_masuk" name="form_daftar_masuk" method="post" action="btm_daftar_surat_masuk_peryear_kemaskini_simpan.php"  enctype="multipart/form-data" onSubmit="return checksuratmasuk();" >  
      <table width="90%"  border="0" align="center">                    
          ...
          <tr height="30px">
              ...
              <td>
               <select name="no_ruj_fail_btm">
                  ...
                  <?php 
                  include ("../../../includefail/connection_eBTM.php");
                  $sql_fail = "SELECT * FROM kod_no_ruj_fail_btm WHERE aktif = 'Y'";
          ...
          <td>
           <?php if($dokumen_sokongan == "Tiada")
				  ...
				  {?>
				  <a href="dokumenSokongan/<?=$dokumen_sokongan?>" target="_blank" title="Download">Muat Turun Dokumen</a>&nbsp;<a href="btm_daftar_surat_masuk_del_doc.php?id_daftar=<?=$id_daftar?>" title="Padam Dokumen Sokongan"><img src="../../pic/remove.jpg" width="16" height="16" /></a>
			<?php } ?> 
          </td>                                  
          </tr>
          <tr height="30px">
          ...
          <tr>
           ...
           <tr>
              ...
              <td align="Right">
             	<a href="btm_daftar_surat_masuk_peryear_delete.php?id_daftar=<?=$id_daftar?>&bulan=<?=$bulan?>&tahun=<?=$tahun?>"><img src="../../pic/delete.jpg" width="30" height="38" title="Padam Daftar Surat Masuk"/></a>
              </td>
          </tr> 
      </table>
