...
<script>
  ...
  <form id="form_daftar_keluar" name="form_daftar_keluar" method="post" action="bpf_daftar_surat_keluar_peryear_kemaskini_simpan.php"  enctype="multipart/form-data" onSubmit="return checksuratkeluar();" >  
      <table width="90%"  border="0" align="center">                    
          <tr>
            <td colspan="3" class="titleH1" bgcolor="#990033" style="color:#FFFFFF; padding:3px"><strong>Daftar Surat Keluar BTM</strong></td>
          </tr> 
          <tr>
            <td colspan="3">&nbsp;</td>
          </tr> 
          ...
          <tr height="30px">
           ...
           <tr height="30px">
              ...
              <select name="id_daripada">
                  ...
                  $sql_staf_name = "SELECT * FROM maklumat_staf WHERE activate_status = 'Y' AND bahagian = '9' ORDER BY SORT";
          ...
          <td>
           <?php if($dokumen_sokongan == "Tiada")
				  ...
				  {?>
				  <a href="dokumenSokongan/<?=$dokumen_sokongan?>" target="_blank" title="Download">Muat Turun Dokumen</a>&nbsp;<a href="btm_daftar_surat_keluar_del_doc.php?id_daftar=<?=$id_daftar?>" title="Padam Dokumen Sokongan"><img src="../../pic/remove.jpg" width="16" height="16" /></a>
			<?php } ?>
          </td>                                  
          </tr>
          <tr height="30px">
          ...
          <tr>
           ...
           <tr>
              ...
              <td align="Right">
             	<a href="btm_daftar_surat_keluar_peryear_delete.php?id_daftar=<?=$id_daftar?>&bulan=<?=$bulan?>&tahun=<?=$tahun?>"><img src="../../pic/delete.jpg" width="30" height="38" title="Padam Daftar Surat Masuk"/></a>
              </td>
          </tr> 
      </table>
