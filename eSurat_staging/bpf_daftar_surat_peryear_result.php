...
$colspan = 0;
?>
<div style="font-size:16px"><b><u>Statistik Daftar Surat Masuk(<?=$tahun?>)</U> </b></div>
<p>
    ...
    <td>  
      <div align="center">
        <table width="100%" border="0">
          ...
          <tr>
          	<td align="center"><strong>Daftar Surat Masuk</strong></td>
            <?php
			//  $jumlahtiadaalasanbulan = 0;
              ...
              {	
				...
				switch ($monthloop) {
				 ...
				 $sql_laporan = "SELECT COUNT(id_daftar) AS bilangan, id_daftar FROM maklumat_daftar_surat_masuk WHERE month(tarikh_daftar) = '$bulanloop' AND year(tarikh_daftar) = '$tahun' AND aktif  = 'Y'";
            ...
            <td><?php if (($displayLaporan < 10)&&($displayLaporan >= 1)) { ?>		
                    ...
                    <div align="center">
                    <?php } ?>
                    <a href="bpf_daftar_surat_masuk_list_permonth.php?bulan=<?=$bulanloop?>&tahun=<?=$tahun?>&action=&id_daftar=&jenis_surat=&mode="><?=$displayLaporan?></a>
                    </div>               
            </td> 
